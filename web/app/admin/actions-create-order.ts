...
/* getPickerProductsAdmin (pemuatan ≤200 sekali jalan untuk picker) DIHAPUS
 * 2026-08-26 — digantikan getCatalogPageAdmin di app/admin/catalog-actions.ts
 * (pencarian/kategori di database + halaman 60, kontrak lib/catalog-query.ts).
 * Kebijakan sumbernya tidak berubah: produk ACTIVE, tanpa gerbang
 * sanci_catalog_access, RLS sp_admin_all tetap penegaknya. */
