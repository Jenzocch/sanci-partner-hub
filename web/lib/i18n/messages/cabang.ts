...
const id = {
  ...
  // Penawaran tersimpan (0029, keputusan owner 2026-09-15).
  proposalSaveEmpty: "Penawaran kosong — tidak ada yang bisa disimpan.",
  proposalSaveFeatureOff: "Penyimpanan penawaran belum aktif. Hubungi SANCI Admin.",
  proposalSavedNotFound: "Penawaran itu tidak ditemukan (mungkin milik cabang lain, atau tautannya salah).",
  proposalSavedTitle: "Penawaran tersimpan",
  proposalSavedEmpty: "Belum ada penawaran yang disimpan.",
  proposalSavedOpenCta: "Buka & cetak ulang",
  proposalSavedColNumber: "Nomor",
  proposalSavedColCustomer: "Pelanggan",
  proposalSavedColTotal: "Harga akhir",
  proposalSavedColValid: "Berlaku sampai",
  proposalSavedColSaved: "Disimpan",
  proposalSavedExpired: "Kedaluwarsa",
  proposalSavedListCta: "Lihat penawaran tersimpan",
  ...
  produkDetailMaterialLabel: "Bahan",
  produkDetailConfigLabel: "Konfigurasi",
  produkDetailPackingLabel: "Kemasan",
  produkDetailCbmLabel: "CBM",
  produkDetailWeightLabel: "Berat",
...
const en = {
  ...
  proposalSaveEmpty: "The proposal is empty — there is nothing to save.",
  proposalSaveFeatureOff: "Saving proposals is not active yet. Contact SANCI Admin.",
  proposalSavedNotFound: "That proposal was not found (it may belong to another branch, or the link is wrong).",
  proposalSavedTitle: "Saved proposals",
  proposalSavedEmpty: "No proposals have been saved yet.",
  proposalSavedOpenCta: "Open & reprint",
  proposalSavedColNumber: "Number",
  proposalSavedColCustomer: "Customer",
  proposalSavedColTotal: "Final price",
  proposalSavedColValid: "Valid until",
  proposalSavedColSaved: "Saved",
  proposalSavedExpired: "Expired",
  proposalSavedListCta: "View saved proposals",
  navAria: "Main menu",
  navHome: "Home",
  navOrders: "Orders",
  ...
  produkDetailMaterialLabel: "Material",
  produkDetailConfigLabel: "Configuration",
  produkDetailPackingLabel: "Packing",
  produkDetailCbmLabel: "CBM",
  produkDetailWeightLabel: "Weight",
...
const zh = {
  ...
  proposalSaveEmpty: "报价是空的 —— 没有内容可以保存。",
  proposalSaveFeatureOff: "报价保存功能还没启用。请联系 SANCI Admin。",
  proposalSavedNotFound: "找不到那份报价（可能属于其他门店，或链接有误）。",
  proposalSavedTitle: "已保存的报价",
  proposalSavedEmpty: "还没有保存过任何报价。",
  proposalSavedOpenCta: "打开并重新列印",
  proposalSavedColNumber: "编号",
  proposalSavedColCustomer: "客户",
  proposalSavedColTotal: "最终价格",
  proposalSavedColValid: "有效期至",
  proposalSavedColSaved: "保存时间",
  proposalSavedExpired: "已过期",
  proposalSavedListCta: "查看已保存的报价",
  navAria: "主菜单",
  navHome: "首页",
  navOrders: "订单",
  navProducts: "产品",
  ...
  produkDetailMaterialLabel: "材质",
  produkDetailConfigLabel: "配置",
  produkDetailPackingLabel: "包装",
  produkDetailCbmLabel: "材积 (CBM)",
  produkDetailWeightLabel: "重量",
