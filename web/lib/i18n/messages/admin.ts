...
const id = {
  ...
  // Form Tambah Produk dikelompokkan (owner 2026-09-22: "更符合使用者邏輯,
  // 快速清楚"): urutan mengikuti cara orang memikirkan produk — siapa dia,
  // berapa dan ada atau tidak, lalu detailnya.
  productSecIdentity: "Identitas produk",
  productSecSelling: "Harga & ketersediaan",
  productSecDetail: "Detail & foto",
  productSaveAndNextBtn: "Simpan & tambah lagi",
  productSavedAndNext: "\"{name}\" tersimpan. Isi produk berikutnya — kategori dibiarkan sama.",
  productDiscontinuedLabel: "Akan dihentikan (tidak diproduksi lagi)",
  productDiscontinuedHint: "Sales akan melihat peringatan di katalog, kalkulator, dan saat memilih produk — supaya tidak menjanjikan pesan ulang. Stok yang masih ada tetap bisa dijual.",
  productDiscontinuedFeatureOff: "Penanda \"akan dihentikan\" belum aktif (migrasi 0030 belum dijalankan).",
  productB2bHotelLabel: "Only For B2B Hotel (harga proyek hotel)",
  productB2bHotelHint: "Centang kalau harga dasar produk ini adalah harga proyek hotel jumlah besar — sales melihat peringatan agar tidak menawarkannya ke pelanggan eceran.",
  productB2bHotelFeatureOff: "Penanda B2B Hotel belum aktif (migrasi 0032 belum dijalankan).",
  productSpecsTitle: "Spesifikasi (dari price list)",
  productSpecMaterial: "Bahan",
  productSpecConfiguration: "Konfigurasi",
  productSpecPacking: "Kemasan",
  productSpecCbm: "CBM",
  productSpecWeight: "Berat",
  productSpecsFeatureOff: "Kolom spesifikasi belum aktif (migrasi 0031 belum dijalankan).",
  productSpecsSaveFailed: "Data produk tersimpan, tapi spesifikasi GAGAL disimpan. Buka lagi dan coba simpan ulang.",
  productInternalTitle: "Catatan internal (hanya admin)",
  productInternalHint: "Tidak pernah terlihat oleh partner maupun halaman publik.",
  productOldShowroomPrice: "Harga proyek (hotel, jumlah besar)",
  productDiscontinuedSaveFailed: "Produk tersimpan, tapi penanda \"akan dihentikan\" gagal disimpan. Buka Ubah untuk mencobanya lagi.",
...
const en = {
  ...
  productSecIdentity: "Product identity",
  productSecSelling: "Price & availability",
  productSecDetail: "Details & photo",
  productSaveAndNextBtn: "Save & add another",
  productSavedAndNext: "\"{name}\" saved. Fill in the next product — the category is kept.",
  productDiscontinuedLabel: "Being discontinued (no longer produced)",
  productDiscontinuedHint: "Sales will see a warning in the catalogue, calculator and product picker, so they do not promise a reorder. Remaining stock can still be sold.",
  productDiscontinuedFeatureOff: "The \"being discontinued\" flag is not active yet (migration 0030 has not been run).",
  productB2bHotelLabel: "Only For B2B Hotel (hotel project price)",
  productB2bHotelHint: "Tick when this product's base price is a bulk hotel project price — sales see a warning not to quote it to retail customers.",
  productB2bHotelFeatureOff: "The B2B Hotel flag is not active yet (migration 0032 has not been run).",
  productSpecsTitle: "Specifications (from price list)",
  productSpecMaterial: "Material",
  productSpecConfiguration: "Configuration",
  productSpecPacking: "Packing",
  productSpecCbm: "CBM",
  productSpecWeight: "Weight",
  productSpecsFeatureOff: "Specification fields are not active yet (migration 0031 has not been run).",
  productSpecsSaveFailed: "Product saved, but the specifications FAILED to save. Open it again and retry.",
  productInternalTitle: "Internal notes (admin only)",
  productInternalHint: "Never visible to partners or on the public page.",
  productOldShowroomPrice: "Project price (hotel, bulk)",
  productDiscontinuedSaveFailed: "The product was saved, but the \"being discontinued\" flag failed to save. Open Edit to try again.",
...
const zh = {
  ...
  productSecIdentity: "产品基本资料",
  productSecSelling: "价格与供货",
  productSecDetail: "细节与照片",
  productSaveAndNextBtn: "保存并继续新增",
  productSavedAndNext: "「{name}」已保存。请填写下一个产品 —— 分类会保留。",
  productDiscontinuedLabel: "即将停产（之后不再生产）",
  productDiscontinuedHint: "业务在目录、计算器和选产品时都会看到提示，避免向客户承诺补货。现有库存仍可销售。",
  productDiscontinuedFeatureOff: "「即将停产」标记尚未启用（迁移 0030 还没执行）。",
  productB2bHotelLabel: "Only For B2B Hotel（饭店专案价）",
  productB2bHotelHint: "如果此产品的基本价格是饭店大数量专案价，请勾选 —— 业务会看到提醒，不会报给一般零售客人。",
  productB2bHotelFeatureOff: "B2B Hotel 标记尚未启用（迁移 0032 还没执行）。",
  productSpecsTitle: "规格（来自价格表）",
  productSpecMaterial: "材质",
  productSpecConfiguration: "配置",
  productSpecPacking: "包装",
  productSpecCbm: "材积 (CBM)",
  productSpecWeight: "重量",
  productSpecsFeatureOff: "规格字段尚未启用（迁移 0031 还没执行）。",
  productSpecsSaveFailed: "产品已保存，但规格保存失败。请重新打开再保存一次。",
  productInternalTitle: "内部备注（仅管理员）",
  productInternalHint: "合作伙伴和公开页面都看不到。",
  productOldShowroomPrice: "专案价（饭店、大数量）",
  productDiscontinuedSaveFailed: "产品已保存，但「即将停产」标记保存失败。请打开编辑再试一次。",
