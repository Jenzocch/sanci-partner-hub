...
export interface ItemCoverageError {
  error: true;
  /** Postgres/PostgREST error code — dipertahankan agar caller bisa membedakan
   * schema belum dimigrasikan dari timeout/RLS/backend failure. */
  code?: string;
  /** Detail untuk log internal; tidak pernah langsung ditampilkan ke pengguna. */
  detail?: string;
}
